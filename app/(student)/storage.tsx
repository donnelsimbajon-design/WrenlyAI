  ...
  return (
    <SafeAreaView style={{ flex: 1, backgroundColor: '#FAFAFA' }} edges={['top']}>
      ...
      <ScrollView contentContainerStyle={{ padding: 24, paddingBottom: 100 }}>
        ...
        {/* Device Storage Card */}
        <View style={{ backgroundColor: '#FFFFFF', padding: 20, borderRadius: 12, borderWidth: 1, borderColor: '#F0F2F5', marginBottom: 12, }}>
        ...
        {/* Pending Sync Card */}
        <View style={{ backgroundColor: '#FFFFFF', padding: 20, borderRadius: 12, borderWidth: 1, borderColor: '#F0F2F5', marginBottom: 32, }}>
        ...
        <View style={{ marginBottom: 32 }}>
          ...
          {[
            ...
            <View key={idx} style={{ backgroundColor: '#FFFFFF', padding: 16, borderRadius: 16, borderWidth: 1, borderColor: '#F0F2F5', marginBottom: 12, flexDirection: 'row', alignItems: 'center', }}>
